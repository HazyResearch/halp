...
class BitCenterOptim(SGD):
	...
	"""
	def __init__(self, params, params_name, lr=required, weight_decay=0.0, n_train_sample=1, cast_func=void_cast_func):
		"""
...
class BitCenterSGD(BitCenterOptim):
	...
	"""
	def __init__(self, params, params_name, lr=required, weight_decay=0.0, n_train_sample=1, cast_func=void_cast_func):
		super(BitCenterSGD, self).__init__(params, params_name, lr, weight_decay, n_train_sample, cast_func)
		self.cache_iter = 0

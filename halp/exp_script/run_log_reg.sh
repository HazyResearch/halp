...
python /dfs/scratch0/zjian/floating_halp/halp/halp/exp_script/run_models.py --n-epochs=2 --batch-size=128 --reg=0.5 --alpha=0.05 --momentum=0.0 --seed=1  --n-classes=10  --solver=sgd  --rounding=void  -T=11  --dataset=cifar10  --model=resnet  --cuda
python /dfs/scratch0/zjian/floating_halp/halp/halp/exp_script/run_models.py --n-epochs=2 --batch-size=128 --reg=0.5 --alpha=0.05 --momentum=0.0 --seed=1  --n-classes=10  --solver=bc-sgd  --rounding=void  -T=11  --dataset=cifar10  --model=resnet  --cuda

...
class TestBitCenterLayer(HalpTest):
    ...
    def get_numerical_grad(self, layer, input_fp, input_delta, perturb_eps, target=None):
    ...
    def test_layer_forward_backward_precedures(self, cast_func=single_to_half_det):
